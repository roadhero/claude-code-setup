...
#
# Emits a one-line nudge (as additionalContext) telling Claude to act on the
# project-bootstrap policy (CLAUDE.md section 4C). Stays completely silent unless
# ALL of these hold:
...
# nothing or one hookSpecificOutput JSON object, and exits 0. Requires jq and git,
# already hard dependencies of this config's hooks.
