...
- Read CLAUDE.md §4.3 (Phase 3: Code Reviewer) and §14 (Anti-Patterns), plus android.md §5 (Architecture Patterns), §12 (Reactive Patterns), §13 (Play Store Compliance Watchlist) before reviewing.
